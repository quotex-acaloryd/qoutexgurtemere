...
Simply scroll up, find this offer, and click on the purple **"Show
Coupon Code"** or **"Get Deal"** button. There are other great deals and
promo codes available, too, so make sure you scroll up and browse all of
them to find the one that best fits your needs!
...
3.  Next, you'll want to figure out which promo code you want to apply.
    ...
    Again, just click the purple **"Show Coupon Code"** or **"Get
    Deal"** button you'll notice a popup with the Quotex discount code
    chosen. Copy that code.
